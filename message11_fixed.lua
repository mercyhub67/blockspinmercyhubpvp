...
function Sf:Drive(model, destination, value, t)
    ...
    for i, wp in pairs(waypoints) do
        ...
        while distToGoal > 0.5 and shouldContinue(value) do
            ...
            -- Fix บัค 2: ลงรถแล้วหยุดเลย ไม่ recursive
            ...
            -- Fix บัค 1: ใช้ flat direction กัน Y รบกวนการหันหน้า
            local flatDir = Vector3.new(moveDirection.X, 0, moveDirection.Z)
            local lookTarget = newPos + (flatDir.Magnitude > 0.01 and flatDir or Vector3.new(0, 0, 1))
